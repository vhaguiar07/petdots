...
| 15 | **Declarar no aviso de privacidade que os dados ficam em servidores nos Estados Unidos** — junto da revisão dos itens 4 e 12 | Nasce aqui (13/09/2026), a partir do [ADR-0020](../06-decisions/ADR/0020-hosting-do-piloto-railway-e-cloudflare.md) E10. Texto do aviso em `apps/landing/src/content/privacy.ts` | Hospedar no Railway (Virgínia) é **transferência internacional de dados** pelo art. 33 da LGPD, regulamentada pela Resolução CD/ANPD nº 19/2024. A IA redige a frase quando você mandar; **a leitura jurídica é sua** — e se ela concluir que residência no Brasil é obrigatória, o gatilho (b) do ADR-0020 E11 dispara e a saída nomeada é o Fly.io em São Paulo, a US$ 38 a mais por mês de banco |
